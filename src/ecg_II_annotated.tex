...
;
\draw[color=blue]
(OA1.out) node[above]{$V_3$} ++(0,-0.5) to[short, i<=$i_{RG}$] ++(0,-0.4)
(OA2.out) node[below]{$V_4$} ++(0,0.5) to[short, i_=$i_{RG}$] ++(0,0.4)
(RG1) node[left]{$RA$}
(RG2) node[left]{$LL$}
++(-0.5,0.8) to[short, i=$i_{RG}$] ++(0,0.4)
;
\end{circuitikz}
\end{document}
