...
|- ++(-1,-5)
to[Do=$D_2$, invert] ++(-2,0) coordinate(R14)
to[R=$R_{14}$] ++(0,2) node[vcc]{$V_{CC}$}
(R14) to[R=$R_{15}$, *-] ++(-2,0)
node[pigfete, xscale=-1, anchor=G](Q1){}
(Q1.bulk) node[left]{$Q_1$}
(Q1.S) node[vcc]{$V_{CC}$}
(Q1.D) -- ++(0,-0.5) coordinate(R2) 
--++(0,-1.5) coordinate(FB) 
--++(-1,0)
node[op amp, xscale=-1, noinv input up, anchor=+](OA2){}
(R2) to[R=$R_{17}$, *-] (R2 -| OA2.out) -- (OA2.out)
...
(CD) --++(1,0)
to[Do, l=$D_3$, invert] ++(0,-2) node[ground]{}
(OA2.up) node[vcc]{$V_{CC}$}
(OA2.down) node[vee]{$V_{EE}$}
...
--++(-1,0)
node[op amp, xscale=-1, anchor=+, noinv input up](OPAMP){}
...
(8.2,1.8) rectangle (18,-15)
(13.9,-15) node[above]{Generador de pulso}

(-1.8,-6.2) rectangle (7.8,-12.8)
(2.4,-12.5) node[left]{Filtro 2}
;
\end{circuitikz}
\end{document}
